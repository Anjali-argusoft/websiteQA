...
test.describe(
    'General Fund iBanking Image Scenario',
    async () => {
        let page;
        ...
        test('User sees correct POSB/DBS Bank screenshots', async () => {
            ...
            //Wait and click for POSB/DBS Bank tab in General Fund page 
            ...
            await pageFunc.verifyImageUrl(page, iBankingElms.posbBank['step4'], iBankingURL.gf.posbBank['step4']);

        });

        test('User sees correct OCBC Bank screenshots', async () => {

            //Wait and click for OCBC Bank tab in General Fund page 
            ...
            await pageFunc.verifyImageUrl(page, iBankingElms.ocbcBank['step5'], iBankingURL.gf.ocbcBank['step5']);

        });

        test('User sees correct UOB Bank screenshots', async () => {

            //Wait and click for UOB Bank tab in General Fund page 
            ...
            // Verify Step 3 - Add HOGC as a payee
            await pageFunc.verifyImageUrl(page, iBankingElms.uobBank['step3'], iBankingURL.gf.uobBank['step3']);

        });

        test('User sees correct Standard Chartered Bank screenshots', async () => {

            //Wait and click for SCB Bank tab in General Fund page 
            ...
            // Verify Step 5 - One-Time Giving (FAST)
            await pageFunc.verifyImageUrl(page, iBankingElms.standardCharteredBank['step5'], iBankingURL.gf.standardCharteredBank['step5']);

        });

        test('User sees correct Citibank screenshots', async () => {

            //Wait and click for CitiBank tab in General Fund page 
            ...
            // Verify Step 5 - One-Time Giving (FAST)
            await pageFunc.verifyImageUrl(page, iBankingElms.citiBank['step5'], iBankingURL.gf.citiBank['step5']);
