...
import urlElements from '../locators/pageUrlLocators'; // Page Image Locators
...
test.describe(
    'Heart Community Services Page Image Scenario',
    async () => {
        let page;
        ...
        test('User sees correct Paynow QR code', async () => {
            ...
            await urlFunc.verifyImageUrl(page, urlElements.payNow['payNow_qr_scan'], imageLink.payNow_hcs_scan);
