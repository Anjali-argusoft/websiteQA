...
test.describe(
    'Tithes iBanking Image Scenario',
    async () => {
        let page;
        ...
        test('User sees correct POSB/DBS Bank screenshots', async () => {
            ...
            //Wait and click for POSB/DBS Bank tab in tithes page 
            ...
            await pageFunc.verifyImageUrl(page, iBankingElms.posbBank['step4'], iBankingURL.tithes.posbBank['step4']);

        });

        test('User sees correct OCBC Bank screenshots', async () => {

            //Wait and click for OCBC Bank tab in tithes page 
            ...
            await pageFunc.verifyImageUrl(page, iBankingElms.ocbcBank['step5'], iBankingURL.tithes.ocbcBank['step5']);

        });

        test('User sees correct UOB Bank screenshots', async () => {

            //Wait and click for UOB Bank tab in tithes page 
            ...
            // Verify Step 3 - Add HOGC as a payee
            await pageFunc.verifyImageUrl(page, iBankingElms.uobBank['step3'], iBankingURL.tithes.uobBank['step3']);

        });

        test('User sees correct Standard Chartered Bank screenshots', async () => {

            //Wait and click for SCB Bank tab in tithes page 
            ...
            // Verify Step 5 - One-Time Giving (FAST)
            await pageFunc.verifyImageUrl(page, iBankingElms.standardCharteredBank['step5'], iBankingURL.tithes.standardCharteredBank['step5']);

        });

        test('User sees correct Citibank screenshots', async () => {

            //Wait and click for CitiBank tab in tithes page 
            ...
            // Verify Step 5 - One-Time Giving (FAST)
            await pageFunc.verifyImageUrl(page, iBankingElms.citiBank['step5'], iBankingURL.tithes.citiBank['step5']);
